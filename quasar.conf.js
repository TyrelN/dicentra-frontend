...
module.exports = configure(function (ctx) {
  return {
    ...
    build: {
      ...
      // transpile: false,
      env: {
        API: ctx.dev ? "http://localhost:8000/" : "https://web-1wom0ygrxsk3.up-de-fra1-k8s-1.apps.run-on-seenode.com/"
      },
      ...
      // analyze: true,
      extendWebpack(cfg) {
          cfg.plugins.push(new SitemapPlugin({ base: 'https://nicolavalleyrescue.ca', paths, options: {
