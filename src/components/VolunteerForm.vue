<template>
  <div class="row q-mx-xs" id="volunteer">
    <div class="col-xs-12 col-md-6 q-pa-md">
      <div>{{ volunteerQuestions.question1 }}</div>
      <q-input
        dense
        color="positive"
        outlined
    ...
    <div class="col-xs-12 col-md-12 q-px-md q-pt-md text-center">
      <div class="q-mb-lg">
        By submitting this form I hereby agree to abide by the following
        policies during the time I am volunteering for NVARS: I understand it is
        my decision to volunteer for NVARS, and will not hold NVARS, or any of
        its members, liable for any damage injury or harm caused directly or
        indirectly through my volunteer activities with NVARS.
      </div>
      <div class="q-pa-sm">
        1. I will remember that in all my dealings with the public as a
        volunteer, I am representing NVARS, and that the public will consider my
        words and actions regarding rescue activities representative of the
        attitude and position of NVARS as an organization. If I enter into
        activities of a political or controversial nature, I am doing so as an
        individual, seperate from NVARS and these activites should not occur at
        any NVARS event.
      </div>
      <div class="q-pa-sm">
        2. I will always remember that I represent a non-profit organization and
        cannot profit from any activity related to the organization.
      </div>
      <div class="q-pa-sm">
        3. I understand that NVARS cannot guarantee or be held responsible for
        the health, behavior or temperament of any rescue cat I may handle.
      </div>
      <div class="q-pa-sm">
        4. I attest that the statements and information in this Application are
        accurate to the best of my knowledge. I understand by signing below I
        agree to the policies as set forth in the NVARS Volunteer Application.
      </div>
    </div>
  </div>
</template>
